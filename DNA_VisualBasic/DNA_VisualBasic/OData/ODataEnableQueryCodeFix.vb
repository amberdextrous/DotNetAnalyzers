...
<ExportCodeFixProvider(LanguageNames.VisualBasic, Name:=NameOf(ODataEnableQueryCodeFix)), [Shared]>
Public Class ODataEnableQueryCodeFix
    Inherits CodeFixProvider

    ' TODO: Replace with actual diagnostic id that should trigger this fix.
    ' TODO: Replace with actual diagnostic id that should trigger this fix.
    Public Const DiagnosticId As String = ODataEnableQueryAnalyzer.DiagnosticId
    Private Title As String = "Add <EnableQuery>"
    ...
    Public NotOverridable Overrides Async Function RegisterCodeFixesAsync(context As CodeFixContext) As Task
        ...
        CodeAction.Create(title:=Title, equivalenceKey:=Title,
                         createChangedDocument:=Function(c) EnableQueryAsync(context.Document, node, c)), diagnostic)
    End Function
