...
<ExportCodeFixProvider(LanguageNames.VisualBasic, Name:=NameOf(ODataCheckFromODataUriCodeFix)), [Shared]>
Public Class ODataCheckFromODataUriCodeFix
    Inherits CodeFixProvider
    ' TODO: Replace with actual diagnostic id that should trigger this fix.
    Public Const DiagnosticId As String = ODataCheckFromODataUriAnalyzer.DiagnosticId
    ...
    Public NotOverridable Overrides Async Function RegisterCodeFixesAsync(context As CodeFixContext) As Task
        ...
        CodeAction.Create("Add <FromODataUri>",
                          Function(c) ApplyFromODataUriAsync(context.Document, node, c), equivalenceKey:=DiagnosticId), diagnostic)
    End Function
