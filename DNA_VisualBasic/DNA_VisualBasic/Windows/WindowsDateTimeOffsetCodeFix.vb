...
<ExportCodeFixProvider(LanguageNames.VisualBasic, Name:=NameOf(WindowsDateTimeOffsetCodeFix)), [Shared]>
Public Class WindowsDateTimeOffsetCodeFix
    Inherits CodeFixProvider

    ' TODO: Replace with actual diagnostic id that should trigger this fix.
    Public Const DiagnosticId As String = WindowsDateTimeOffsetAnalyzer.DiagnosticId
    ...
    Public NotOverridable Overrides Async Function RegisterCodeFixesAsync(context As CodeFixContext) As Task
        ...
        If TypeOf (node) Is PredefinedTypeSyntax Then
            ...
            CodeAction.Create("Replace with DateTimeOffset",
                              Function(c) ReplaceDateAsync(context.Document, node, c), equivalenceKey:=DiagnosticId), diagnostic)
        Else
            context.RegisterCodeFix(
            CodeAction.Create("Replace with DateTimeOffset",
                              Function(c) ReplaceDateTimeAsync(context.Document, node, c), equivalenceKey:=DiagnosticId), diagnostic)
        End If
    End Function
